class I18n(object):
    ...
    ERROR_DELETE_PRODUCT = "Erro ao deletar produto"

    NOT_FOUND_CATEGORY_TO_ITEM = "Categoria do produto não foi encontrada"
    NOT_FOUND_PRODUCT = "Produto não foi encontrado"